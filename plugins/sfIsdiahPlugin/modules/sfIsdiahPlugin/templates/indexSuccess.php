...
<?php if (isset($latitude) && isset($longitude) && null !== $keyProperty = QubitSetting::getByName('google_maps_api_key')): ?>
  <div id="front-map" class="simple-map" data-key="<?php echo $keyProperty->value ?>" data-latitude="<?php echo $latitude ?>" data-longitude="<?php echo $longitude ?>"></div>
<?php endif; ?>
